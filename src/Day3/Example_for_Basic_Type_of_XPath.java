...
public class Example_for_Basic_Type_of_XPath {
	@Test
	...
	public void xPath() throws InterruptedException {
		...
		driver.findElement(By.xpath("(//div[@class='bn fi et bp bo'])[4]")).click();	
		Thread.sleep(2000);	
		
		//click log in to order&delever
		driver.findElement(By.xpath("//input[@inputmode='email']")).sendKeys("ram@gmail.com");	
		Thread.sleep(2000);	
